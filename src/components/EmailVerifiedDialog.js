        ...
        <Dialog fullScreen={fullScreen} open={open}>
          ...
          <DialogContent style={{ fontFamily: "Arial" }}>
            <Typography
              align={"justify"}
              variant={"subtitle1"}
              className={`${classes.body} ${classes.typography}`}
            >
              ...
              app.
              <br />
              <br />- If you haven’t received your verification email, check
              your spam folder or click
              <b className={classes.link} onClick={this.handleResendEmail}>
                {" "}
                here
              </b>{" "}
              to resend it.
              <br />
              <br />- to carry on without activating your account, click
              <b className={classes.link} onClick={this.handleSignOut}>
                {" "}
                sign out
              </b>
